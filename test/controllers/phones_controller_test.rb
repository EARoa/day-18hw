...
class PhonesControllerTest < ActionController::TestCase
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post :create, phone: { brand: @phone.brand, instock: @phone.instock, name: @phone.name, photo_url: @phone.photo_url, price: @phone.price }
    end
  ...
  test "should update phone" do
    patch :update, id: @phone, phone: { brand: @phone.brand, instock: @phone.instock, name: @phone.name, photo_url: @phone.photo_url, price: @phone.price }
    assert_redirected_to phone_path(assigns(:phone))
  end
